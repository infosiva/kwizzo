      ...
      <nav className="sticky top-0 z-50" style={{ background: 'rgba(13,6,24,0.60)', backdropFilter: 'blur(24px)', borderBottom: '1px solid rgba(139,92,246,0.15)' }}>
        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-1 text-sm">
            ...
            <Link href="/#how-it-works"    className="px-3 py-1 rounded-full border border-white/10 text-white/60 hover:text-white hover:border-violet-500/40 transition-all">Topics</Link>
            <Link href="/#pricing"     className="px-3 py-1 rounded-full border border-white/10 text-white/60 hover:text-white hover:border-violet-500/40 transition-all">Pricing</Link>
        ...
        {open && (
          <div className="md:hidden border-t border-white/[0.06] px-6 py-4 flex flex-col gap-3 text-sm">
            ...
            <Link href="/#how-it-works"    className="text-white/70 hover:text-white" onClick={() => setOpen(false)}>Topics</Link>
            <Link href="/#pricing"     className="text-white/70 hover:text-white" onClick={() => setOpen(false)}>Pricing</Link>
