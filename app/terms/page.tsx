...
export const metadata: Metadata = {
  title: "Terms of Service | Kwizzo",
  description: "Terms of service for Kwizzo — your rights and responsibilities when using our service.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Acceptance of Terms">
        <p>
          By accessing or using Kwizzo (https://kwizzo.app), you agree to be bound by these Terms of Service.
          If you do not agree, please do not use the service.
        </p>
      </Section>

      <Section title="2. Description of Service">
        <p>AI-powered family quiz game for all ages — play free with no sign-up required.</p>
        <p className="mt-2">
      ...
      <Section title="5. Intellectual Property">
        <p>
          All original content, design and code on this service is owned by or licensed to Kwizzo.
      ...
      <Section title="9. Limitation of Liability">
        <p>
          To the fullest extent permitted by law, Kwizzo shall not be liable for any indirect,
      ...
      <p className="mt-10 opacity-40 text-xs">© 2026 Kwizzo. All rights reserved.</p>
    </main>
  );
}
