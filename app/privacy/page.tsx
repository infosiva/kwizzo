...
export const metadata: Metadata = {
  title: "Privacy Policy | Kwizzo",
  description: "Privacy policy for Kwizzo — how we collect, use and protect your data.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>Kwizzo (https://kwizzo.app) is operated by an independent developer. AI-powered family quiz game for all ages — play free with no sign-up required.</p>
