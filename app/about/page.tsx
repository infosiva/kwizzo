...
export const metadata: Metadata = {
  title: "About | Kwizzo",
  description: "About Kwizzo — AI-powered family quiz game for all ages — play free with no sign-up required.",
...
export default function AboutPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      <h1 className="text-3xl font-bold mb-6">About Kwizzo</h1>

      <section className="mb-8">
        <p className="text-base leading-7">AI-powered family quiz game for all ages — play free with no sign-up required.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          Kwizzo is a free service built to make learning more accessible through the power of artificial intelligence.
      ...
      <section className="mb-8">
        ...
        <p>
          Kwizzo is supported by advertising through Google AdSense. Ads help us keep the service
